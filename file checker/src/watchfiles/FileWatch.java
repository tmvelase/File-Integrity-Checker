  ...
  private FileWatcher watcher;
    ...
    public String inspect(String location) {
        ...
        try {
            ...
            String prg = "python C:\\Users\\thamu\\Desktop\\MalwareDetection\\testc.py";
           // String arg = "C:\\Users\\thamu\\Desktop\\MalwareDetection\\test\\malicious.exe";
            
            String prg1 = prg + " " + location;
            String ret = "initial";
            System.out.println(prg1); String x ="x";
           
           // Process p = Runtime.getRuntime().exec("python C:\\Users\\thamu\\Desktop\\MalwareDetection\\testc.py C:\\Users\\thamu\\Desktop\\MalwareDetection\\test\\malicious.exe");
            Process p = Runtime.getRuntime().exec(prg1);
    ...
    watcher.addFileEventsListener(new com.teamdev.filewatch.FileEventsListener() {
      public void fileAdded(com.teamdev.filewatch.FileEvent.Added e) {
         ...
         path = path.substring(11, (path.length()-1));
          ...
          if (".exe".equals(extension) ||".dll".equals(extension) || ".sys".equals(extension)){
              System.out.print(path+"\n");
              System.out.print(extension + "\n");
              inspect(path);
              String res = inspect(path);
               FileWatch.this.writeToConsole(res.toString());
                popup pop = new popup();
                pop.setlabel(res);
               pop.setVisible(true);
          }  
      ...
      public void fileChanged(com.teamdev.filewatch.FileEvent.Changed e) {
        ...
        String path = e.toString();
         path = path.substring(13, (path.length()-1));
          String extension = path.substring((path.length()-4), path.length());
